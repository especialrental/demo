    ...
    <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper" style="min-height: 505px;">
        ...
        <section class="content-header">
          <h1 style="display:flex;justify-content:space-between;align-items:center;">Blog List
            <div class="pull-right"><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#areaModal">Add Blog</button></div>
          </h1>
          <div class="pull-left">
            <div id="message"></div>
          </div>
          @if(Session::get('message'))
            <h4 class="pull-left alert alert-success blog-success-msg">{{Session::get('message')}}</h4>
          @endif
          @if ($errors->any())
            <div class="alert alert-danger blog-error">
              <ul>
                ...
                <div class="modal-body" style="overflow: hidden;">
                  ...
                  <div class="col-lg-12" id="editarea">
                    ...
                    <div class="form-group">
                      ...
                      <textarea  id="description"  style="height:200px;" name="description" class="form-control description"></textarea>
                    </div>
                    <div class="form-group">
                      <label>URL</label>
