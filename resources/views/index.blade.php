				...
				<div class="col-lg-12" style="width: 367px;">
						...
						<div class="property-item">
							...
							<div class="img-box">
								...
								<a href="{{url('/')}}/{{$cityUrl}}/{{$room}}/{{$area}}/{{$pro}}" target="_blank" class="img-box__image"><img src="{{url('public/uploads/property_image')}}/{{$data->id}}/{{ $username }}" data-src="{{url('public/uploads/property_image')}}/{{$data->id}}/{{ $username }}" alt="Property" class="lazyload img-responsive"></a>
							</div>
		...
		<div class="container">
			...
			<div class="section-header header-column" style="background:#fbfbfb">
				...
				<div class="slide-control">
					<button id="content-left" class="slide-left content-left" aria-label="Slide Content Left"><i class="fa fa-angle-left"></i></button>
					<button id="content-right" class="slide-right content-right" aria-label="Slide Content right"><i class="fa fa-angle-right"></i></button>
				</div>
			</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="testimony-profile text-center">
										...
										<img src="{{url('/')}}/public/uploads/testimonial/{{$testimonial->image}}" alt="{{$testimonial->name}}">
										@else
										<img src="{{url('public/frontend/images')}}/img_author_default.jpg" alt="{{$testimonial->name}}">
										@endif
			...
			<div class="row">
				<div class="col-md-2 col-xs-2 col-sm-2  px-2">
					...
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/trip.webp" data-src="{{url('/')}}/public/frontend/images/trip.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
				<div class="col-md-2 col-xs-2 col-sm-2  px-2 ">
					<!-- Partner Item -->
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/booking.webp" data-src="{{url('/')}}/public/frontend/images/booking.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
				<div class="col-md-2 col-xs-2 col-sm-2  px-2">
					<!-- Partner Item -->
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/airbnb.webp" data-src="{{url('/')}}/public/frontend/images/airbnb.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
				<div class="col-md-2 col-xs-2 col-sm-2  px-2">
					<!-- Partner Item -->
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/homeaway.webp" data-src="{{url('/')}}/public/frontend/images/homeaway.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
				<div class="col-md-2 col-xs-2 col-sm-2  px-2">
					<!-- Partner Item -->
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/vrbo.webp" data-src="{{url('/')}}/public/frontend/images/vrbo.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
				<div class="col-md-2 col-xs-2 col-sm-2  px-2">
					<!-- Partner Item -->
					<div class="partner-item">
						<a href="#"><img src="{{url('/')}}/public/frontend/images/9flat.webp" data-src="{{url('/')}}/public/frontend/images/9flat.webp" alt="Partner" class="lazyload"></a>
					</div>
				</div>
			</div>  
		</div>
        ...
        function initMap() {
            ...
            function addMarker(feature) {
                ...
                var infowindow = new google.maps.InfoWindow({
                    content:'<div class="property-info"></div>'
                });
