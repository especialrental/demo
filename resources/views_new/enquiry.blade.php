            ...
            <div class="section-header2">
             ...
             <form class="needs-validation" action="#" enctype="multipart/form-data" id="prop_enquiry">
                 ...
                 <input type="hidden" name="night" id="night" value="{{$daysInDates}}">
                                ...
                                <div class="form-group">
                                    <div class="row" style="margin-bottom:30px">
                                        <div class="col-md-2">
                                            ...
                                            <select name="gen" id="gen" required class="form-select form-select-sm form-control" aria-label=".form-select-sm example">
                                    ...
                                    <div class="row" style="margin-bottom:30px">
                                        ...
                                        <div class="col-md-6">
                                            <sup class="pull-right text-danger">*</sup>
                                            <input type="text" id="mob" name="mob" max="10" class="form-control" placeholder="Phone Number" required="required">
                    ...
                    <button type="button" id="enquiryClick" name="submit" class="btn btn-warning btn-block buy_now">Submit</button>
                </div>  
...
<style>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            data:{pro_id:pro_id,pro_name:pro_name,fname:fname,lname:lname,email:email,mob:mob,comment:comment,gen:gen,how_did_you:how_did_you,mformate:mformate,business:business,myself:myself,checkin:checkin, checkout:checkout,guest:guest,night:night, _token:token},
            method:"POST",
			success : function(result) {
            window.location.href ='{{url('/')}}/property/enquiry-thank-you';
