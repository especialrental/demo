                   ...
                   <div class="box-body pad">
                      ...
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="propertyname" id="propertyname" class="form-control required" placeholder="Enter ..." value="{{$propName}}">
                      ...
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="url" id="url" class="form-control required" placeholder="Enter ..." value="{{$propUrl}}">
                      ...
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                        <div class="form-group">
                          ...
                          <input type="text" name="bed_type" class="form-control required" placeholder="Enter ..." value="{{$bedType}}">
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                        <div class="form-group">
                          ...
                          <input type="text" name="check_in" class="form-control required" placeholder="Enter ..." value="{{$checkIn}}">
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                        <div class="form-group">
                          ...
                          <input type="text" name="check_out" class="form-control required" placeholder="Enter ..." value="{{$checkOut}}">
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-12"  style="padding-left:0px;">
                        <div class="form-group">
                          ...
                          <input type="text" name="room_type" class="form-control required" placeholder="Enter ..." value="{{$roomType}}">
                        </div>
                      </div>
