    ...
    color: #ff7226;display:none;" >Make an enquiry</h3>
		...
		<section class="mt-5 mb-5">
				...
				<div class="blogDetailWrapper">
                    ...
                    <p>As Dublin is a popular holiday destination, the <a href="https://www.especialrentals.com/">best apartments to rent in Dublin</a> get booked in no time! So, once you have decided to visit the city, you should immediately start looking for holiday apartments to rent in Dublin and secure the one you like the most.</p>
			        ...
			        <p>You can pick a property in any of the above locations based on your interest, budget, and availability. You can conveniently find long-term <a href="https://www.especialrentals.com/blogs/dublin-vacation-rentals-the-ultimate-guide-to-finding-the-perfect-accommodation">rental apartments in Dublin</a> in these locations even if you plan to stay in the city for a long. All you have to do is be careful with the choices and book a rental apartment through a trusted company to enjoy a smoother and fuss-free stay! </p>
				</div>
			</div>
		</section>
		...
		<section class="mt-5 mb-5">
				...
				<div class="blogDetailWrapper">
                    ...
                    <p>If you also prefer any of these locations for <a href="https://www.especialrentals.com/blogs/london-apartments-for-rent-find-your-perfect-home-in-the-heart-of-the-city">apartments for rent in London,</a> rest assured that there will be enough options! So, start exploring to find your holiday abode in London.</p>
				</div>
			</div>
		</section>
